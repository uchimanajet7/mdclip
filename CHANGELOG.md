# Prompt Launcher Changelog

## [Initial Release] - {PR_MERGE_DATE}

- Add Prompt Set 1, Prompt Set 2, Prompt Set 3, and All Prompt Sets commands.
- Add Prompt Set enable switches to exclude unused Prompt Sets without removing folder settings.
- Make Prompt Set settings easier to scan in Preferences.
